...
**Next session:** v0.3 release decision (the user's call — dogfood gate PASSED 2026-08-19, all 10 continuity questions answered with lineage over the ingested repo; PR #1 carries K1–K5). Open items after certification GO (2026-08-25): EVO-003 apply/migrate op + wire-format versioning (the one P0 partial — decision needed: 1.0 blocker vs recorded deferral), RET-CHAT-001 retention/expiry (G13), §38–39 conversation summarization, §40 memory compression, MEM-001 working memory, PROG-CHAT discovery/approval, AGENT-003/005 agent loops, MRFC-0070 A2 non-Rust parsers, MRFC-0060 ~5% polish (index-backed uniqueness, conditional uniqueness, pushdown verification), KVM bytecode, temporal-policy retrieval item (G11 measured 0.0 suppression)
