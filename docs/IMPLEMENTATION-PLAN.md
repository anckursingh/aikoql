...
**Next session:** K5 (Agent Experience — Experience KOs with reuse-condition matching in compile_context, TTL) on `feature/mvp-launch`, measured against the per-phase exit criteria
