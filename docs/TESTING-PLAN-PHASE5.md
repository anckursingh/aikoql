...
| P5-M1 | Planner semantics remainder | ND-01 | ⬜ | alg001–002; proptest suite green (seeded); every documented rewrite has an executable test; optimize-vs-unoptimized divergence 0 |
| P5-M2 | KOQL v1 remainder | ND-02 | ⬜ | kq001–009; grammar_coverage + golden + fuzz suites extended green; existing query APIs untouched |
...
- **P5-M2:** kq001–009 green; existing compiler suites (golden 13/13, grammar_coverage 42/42, fuzz 4/4) extended green; MCP `aikoql` tool untouched-green.
