        ...
        Doc {
            ...
            ir: KnowledgeIr {
                entities: vec![entity(
                    "RouteDelta",
                    "Route",
                    "RouteDelta was rerouted to the East corridor in August.",
                    "ho-route-update",
                )],
                facts: vec![fact(
                    "RouteDelta was rerouted to the East corridor in August.",
...
pub const HOLDOUT_QUESTIONS: &[Question] = &[
    ...
    Question {
        ...
        gt: g(
            "none",
            "ho-driver",
            "DriverMax assigned_to RouteDelta",
            "current",
            "documentation",
            "none",
        ),
    ...
    Question {
        ...
        gt: g(
            "none",
            "ho-compliance",
            "HubCheckpoint verifies ElkLogPolicy",
            "current",
            "organization_policy",
            "none",
        ),
    ...
    Question {
        ...
        gt: g(
            "either documented corridor; both sources present",
            "any",
            "DispatchNotes conflicts_with RouteSheet",
            "current",
            "documentation",
            "conflict",
        ),
