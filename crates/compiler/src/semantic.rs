...
impl<'a> SemanticAnalyzer<'a> {
    ...
    fn resolve_entity(&self, name: &str) -> Result<&Schema, Diagnostic> {
        self.registry.get(name).ok_or_else(|| diagnostics::unknown_type(name, 0, 0))
    }
